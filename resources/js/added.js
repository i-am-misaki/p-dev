document.addEventListener("DOMContentLoaded", function(){
    ...
    // console.log(selectTag_options_list);

    // let selectTag_options_value = selectTag_options.value;
    ...
    current.textContent = today.getMonth()+1 + '月';
    // 先月
    let oneM = document.getElementById('1');
    oneM.textContent = today.getMonth() + '月';
    // 先々月
...
function show_month_data(selected_month){
    ...
    xhr.onreadystatechange = function(){
        if(xhr.readyState == 4 && xhr.status == 200){
            ...
            // let month = selected_month.substr(5,2);
            // console.log(month);
...
let selectTag = document.getElementById('tsuki');
let selectTag_options = selectTag.options;
...
function displayData(skilldatas, selected_month){
    ...
    // // optionタグのIDリスト
    // let selectTag_options_list = [];
    // for(let i = 0; i < selectTag_options.length; i++){
    //     selectTag_options_list.push(selectTag_options[i]);
    // }

    // for(let i = 0; i < selectTag_options_list.length; i++){
        // if(selectTag.value == selected_month){
        //     // selectTag_options_list[i].selected = true;
        //     // console.log(selectTag_options[i].value);
        //     // console.log(selectTag.options[i]);
        //     selectTag.options[i].setAttribute('selected', true);
        //     // selectTag.options.selected = selectTag.options[i].innerText;
        //     console.log(selectTag.options[i]);
        // }
    // }
