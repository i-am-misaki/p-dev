    ...
    <div class="flex justify-center py-10 w-full">
        <div class="w-2/3">
            <div id="ajax-div" class="relative">
                <select id="tsuki" name='tsuki' class="w-24 h-11 rounded py-2 px-4 gap-2 font-Robot font-bold text-2xl">
                    <option id="0" value="<?php echo $currentMonth; ?>"></option>
                    <option id="1" value="<?php echo $oneMonthAgo; ?>"></option>
                    <option id="2" value="<?php echo $twoMonthAgo; ?>"></option>
                </select>
